...
import MenuLogo from "../../assets/icons/logo-quas.svg";
import MenuLogoMob from "../../assets/icons/logo-mobile.svg";
import MenuWallet from "../../assets/icons/wallet icon.svg";
import { ReactComponent as MenuToken } from "../../assets/tokens/token-quasar.svg";
...
function Header({ handleDrawerToggle, drawe }: IHeader) {
    ...
    let burg = document.querySelector(".MuiDrawer-modal");
    let burger = document.querySelector(".burger");
    let rootB = document.getElementById("root");
    burger?.addEventListener("click", function () {
        burger?.classList.add("active");
        rootB?.classList.add("active");
    });
    if (burger?.classList.contains("active")) {
        burger?.addEventListener("click", function () {
            burger?.classList.remove("active");
            rootB?.classList.remove("active");
        });
        ...
        <div className="dapp-topbar">
            <div className="container">
                <div className="logo">
                    ...
                    <img className="logo-mobile" src={MenuLogoMob} alt="logo" />
                </div>
                ...
                <div onClick={handleDrawerToggle} className="dapp-topbar-slider-btn">
                    <div className="burger">
                        <span className="burger-center-line"></span>
                    </div>
                </div>
            </div>
        </div>
