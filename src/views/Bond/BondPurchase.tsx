...
function BondPurchase({ bond, slippage, recipientAddress }: IBondPurchaseProps) {
    ...
    return (
        <Box display="flex" flexDirection="column">
            <Box className="block-input-but" display="flex" justifyContent="space-around" flexWrap="wrap">
                {bond.name === "wavax" && (
            ...
            <Slide direction="left" in={true} mountOnEnter unmountOnExit {...{ timeout: 533 }}>
                <Box className="bond-data">
                    ...
                    <div className="data-row">
                        ...
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4)} QUAS`}</p>
                    </div>
                    ...
                    <div className="data-row">
                        ...
                        <p className="bond-balance-title">0.01 QUAS</p>
                    </div>
